...
PreparedStatement insert2 = conn.prepareStatement("insert into mangatype (mt_name) values (?)");
insert2.setString(1, mt_name);
...
<%
//แสดงค่า
PreparedStatement pstmt1 = conn.prepareStatement("SELECT * FROM mangatype");
...
<table style="border:1">
            ...
            %>
            <tr>
                <td><%= rs.getString("mt_id") %></td>
                <td><%= rs.getString("mt_name") %></td>
                <td>
            <!-- Delete button -->
            <form action="" method="post">
                <input type="hidden" name="delete_id" value="<%= rs.getString("mt_id") %>">
