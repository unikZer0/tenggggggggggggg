...
<body>
    <div class="container">
        ...
        <div class="con-typenav">
            <div class="typenav">
                <ul>
                    ...
                    <li><a href="./system.jsp" class="cruime">system</a></li>
                    <li><a href="./revags.jsp" class="fantasy">revangs</a></li>
                    <li><a href="./isekai.jsp" class="u">isekai</a></li>
                    <li><a href="./magic.jsp" class="crime">magic</a></li>
        ...
        <br>
        <p class="margin">magic</p>
        <br>
        <div class="con-cont">
            <div class="main-cont">
            <%
            //แสดงค่า
            PreparedStatement pm = conn.prepareStatement("SELECT * FROM manga where mt_id=7");
