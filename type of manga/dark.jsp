        ...
        <div class="con-typenav">
            <div class="typenav">
                <ul>
                    ...
                    <li><a href="./dark.jsp" class="crime">dark fantasy</a></li>
                    <li><a href="./action.jsp" class="thrillers">action</a></li>
                </ul>
            </div>
        </div>
        <br>
        <p class="margin">dark fantasy</p>
        <br>
        <div class="con-cont">
            <div class="main-cont">
            <%
            //แสดงค่า
            PreparedStatement pm = conn.prepareStatement("SELECT * FROM manga where mt_id=4");
