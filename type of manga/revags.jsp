        ...
        <div class="con-typenav">
            <div class="typenav">
                <ul>
                    ...
                    <li><a href="./system.jsp" class="u">system</a></li>
                    <li><a href="./revags.jsp" class="crime">revangs</a></li>
                    <li><a href="./isekai.jsp" class="u">isekai</a></li>
                    <li><a href="./magic.jsp" class="u">magic</a></li>
                    <li><a href="./harem.jsp" class="u">harem</a></li>
                    <li><a href="./dark.jsp" class="u">dark fantasy</a></li>
                    <li><a href="./action.jsp" class="u">action</a></li>
                </ul>
            </div>
        </div>
        <br>
        <p class="margin">revangs</p>
        <br>
        <div class="con-cont">
            <div class="main-cont">
            <%
            //แสดงค่า
            PreparedStatement pm = conn.prepareStatement("SELECT * FROM manga where mt_id=8");
