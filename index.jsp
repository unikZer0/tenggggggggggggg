...
<body>
    <div class="container">
        ...
        <div class="con-advert">
            
        </div>
        <hr>
        <br>
        <div class="con-trending">
            <div class="trend"><a href="book.jsp"><h2>ປຶ້ມທີ່ກຳລັງນິຍົມ
            </h2></a></div>
            <div class="trend"><a href="book.jsp"><h4>ເບິ່ງທັງຫມົດ</h4></a></div>
        </div>
        <div class="con-cont">
            <div class="main-cont">
            <%
            ...
            %>
                 <%
                    while (rsb.next()) {
                 %>
                 <div class="mybook"><a href="../type" class=""><img src="assets/pictures/pic_book/adventure/<%= rsb.getString("b_image") %>" alt="" class="coverbook"></a></div>
                <%
                }
                %>
            </div>
        ...
        <br>
        <div class="con-trending">
            <div class="trend"><a href="manga.jsp"><h2>ປຶ້ມກາຕູນທີ່ກຳລັງນິຍົມ</h2></a></div>
            <div class="trend"><a href="manga.jsp"><h4>ເບິ່ງທັງຫມົດ</h4></a></div>
        </div>
        <div class="con-cont">
            <div class="main-cont">
                        <%
            ...
            %>
                 <%
                    while (rsm.next()) {
                 %>
                 <div class="mymanga"><a href="#" class=""><img src="assets/pictures/pic_manga/<%= rsm.getString("m_image") %>" alt=""></a></div>
                <%
                }
                %>
            </div>
